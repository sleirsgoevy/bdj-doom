//copy-pasted from https://github.com/SimonKagstrom/cibyl/blob/080408dc232525f93522e51fdb0e8c6c57d96d79/libs/src/libmidp/resource-filesystem.c
//modified
#include <stdlib.h>
#include <string.h>
                  ...
                  cibyl_fops_open_mode_t mode)
{
  ...
  NOPH_try(NOPH_setter_exception_handler, (void*)&error)
    {
      NOPH_Class_t cl = NOPH_MyXlet_getclass();
